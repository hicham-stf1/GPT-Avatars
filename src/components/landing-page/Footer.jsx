  ...
  return (
    <footer className="py-12 bg-white sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        {/* <ul className="flex flex-col items-center justify-center space-y-6 mt-10 sm:space-y-0 sm:flex-row sm:space-x-12 md:space-x-16">
          <li>
            <a
              href="#"
              title="About"
              className="inline-flex text-lg font-medium text-gray-900 transition-all duration-200 transform hover:-translate-y-1 hover:text-gray-600"
            >
              About
            </a>
          </li>
          ...
          <svg className="w-auto h-4 mx-auto text-gray-300" viewBox="0 0 172 16" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            {[...Array(24)].map((_, i) => (
              <line
                ...
                x2="18.0278"
                y2="-0.5"
                transform={`matrix(-0.5547 0.83205 0.83205 0.5547 ${11 + i * 35} 1)`}
              />
            ))}
          </svg>
        </div>
        ...
        <p className="mt-7 text-base font-normal text-center text-gray-600">© Copyright 2024, All Rights Reserved</p>
      </div>
    </footer>
  );
};
